...
Gradle unit tests executed all 6 Android policy/reducer tests successfully on 2026-09-16. Connected instrumentation executed all 4 Android tests successfully on `emulator-5554` on 2026-09-16, including legacy-preferences migration into SQLite. Manual ADB smoke testing also confirmed the installed APK reaches onboarding, the Vaani IME can be enabled and selected, and the rehearsal field displays the Vaani keyboard even when the emulator advertises a hardware keyboard.

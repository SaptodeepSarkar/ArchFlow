...
| Tests | 85 passing Rust tests plus one ignored hardware test, 8 Android policy/reducer tests, 8 connected Android tests, and 19 portable desktop tests; no native desktop test suite | KEEP coverage; ADD platform and contract tests |

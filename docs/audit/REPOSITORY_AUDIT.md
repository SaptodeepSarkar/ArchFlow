...
| Tests | 76 passing Rust tests plus one ignored hardware test, 7 Android policy/reducer tests, 5 connected Android tests, and 13 portable desktop tests; no native desktop test suite | KEEP coverage; ADD platform and contract tests |

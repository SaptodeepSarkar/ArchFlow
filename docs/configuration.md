...
| recognition.server_idle_secs | 0–600 (30) | Resident LLM/STT TTL; 0 = one-shot per call |
...
| cleanup.mode | raw/clean/stream | stream is the default and auto-cleans the finished transcript with the local LLM; raw disables cleanup |
